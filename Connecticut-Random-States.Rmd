---
title: "Connecticut COVID-19 Analysis"
author: "David J. Jackson"
date: "02/11/2021 7:25 PM/EST"
output: 
  html_document: 
    fig_width: 9
    fig_height: 7
...
```{r}
cancer <- dbGetQuery(db,"select * from Cancer where STATE ='CT'")
...
```{r}
heart <- dbGetQuery(db,"select * from HeartDisease where STATE ='CT'")
