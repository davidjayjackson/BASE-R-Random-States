---
title: "Arizona Covid-19 Analysis"
author: "David RJ Jackson"
date: "02/11/2021 7:15 PM/EST"
...
```{r}
rm(list=ls())
db <- dbConnect(RSQLite::SQLite(),dbname= "../COVIDDB/NYTimes.sqlite3")
...
cancer <- dbGetQuery(db,"select * from Cancer where STATE ='AZ'")
...
```
```{r}
heart <- dbGetQuery(db,"select * from HeartDisease where STATE ='AZ'")
...
VI <- subset(VI,date>="2020-03-03" & Rate >0)
